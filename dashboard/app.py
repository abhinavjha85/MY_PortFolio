...
@st.cache_data
def load_data():
    df = pd.read_csv('/Users/abhinavjha/NeuralRetail/data/processed/clean_data.csv')
    df['InvoiceDate'] = pd.to_datetime(df['InvoiceDate'])
    return df

@st.cache_data
def load_segments():
    return pd.read_csv('/Users/abhinavjha/NeuralRetail/data/processed/customer_segments.csv')
